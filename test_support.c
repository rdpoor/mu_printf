...
int main() {
  MAKE_MU_PRINTF_TEST("%d", 0);
  MAKE_MU_PRINTF_TEST("%+d", 0);
  MAKE_MU_PRINTF_TEST("% d", 0);
  MAKE_MU_PRINTF_TEST("%-d", 0);
  MAKE_MU_PRINTF_TEST("%10d", 0);
  MAKE_MU_PRINTF_TEST("%-10d", 0);
  MAKE_MU_PRINTF_TEST("%10.5d", 0);

  MAKE_MU_PRINTF_TEST("%d", 1);
  MAKE_MU_PRINTF_TEST("%d", -1);
  MAKE_MU_PRINTF_TEST("%10d", 1);
  MAKE_MU_PRINTF_TEST("%10d", -1);
  MAKE_MU_PRINTF_TEST("%10.5d", 1);
  MAKE_MU_PRINTF_TEST("%10.5d", -1);

  MAKE_MU_PRINTF_TEST("%0d", 1);
  MAKE_MU_PRINTF_TEST("%0d", -1);
  MAKE_MU_PRINTF_TEST("%010d", 1);
  MAKE_MU_PRINTF_TEST("%010d", -1);
  MAKE_MU_PRINTF_TEST("%010.5d", 1);
  MAKE_MU_PRINTF_TEST("%010.5d", -1);
  ...
  MAKE_MU_PRINTF_TEST("%d", 123456);
  MAKE_MU_PRINTF_TEST("%d", -123456);
  MAKE_MU_PRINTF_TEST("%10d", 123456);
  MAKE_MU_PRINTF_TEST("%10d", -123456);
  MAKE_MU_PRINTF_TEST("%10.5d", 123456);
  MAKE_MU_PRINTF_TEST("%10.5d", -123456);

  MAKE_MU_PRINTF_TEST("%0d", 123456);
  MAKE_MU_PRINTF_TEST("%0d", -123456);
  MAKE_MU_PRINTF_TEST("%010d", 123456);
  MAKE_MU_PRINTF_TEST("%010d", -123456);
  MAKE_MU_PRINTF_TEST("%010.5d", 123456);
  MAKE_MU_PRINTF_TEST("%010.5d", -123456);
